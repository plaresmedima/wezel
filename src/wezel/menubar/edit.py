...
# menu = Menu('Edit')
# menu.add(action_series_delete)
# menu.add(action_series_copy)
# menu.add(action_series_copy_to)
# menu.add(action_series_move_to)
# menu.add(action_series_merge)
# menu.add(action_series_group)
# menu.add(action_series_split)
# menu.add(action_series_rename)
# menu.add(action_series_extract_by_index)
# menu.add(action_series_extract_by_value)
# menu.add_separator()
# menu.add(action_studies_delete)
# menu.add(action_studies_copy)
# menu.add(action_studies_copy_to)
# menu.add(action_studies_move_to)
# menu.add(action_studies_merge)
# menu.add(action_studies_group)
# menu.add(action_studies_rename)
# menu.add(action_studies_new_series)
# menu.add_separator()
# menu.add(action_patients_delete)
# menu.add(action_patients_copy)
# menu.add(action_patients_merge)
# menu.add(action_patients_rename)
# menu.add(action_patients_new_study)
# menu.add_separator()
# menu.add(action_database_new_patient)